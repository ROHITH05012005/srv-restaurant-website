...
# Update "Ginger Coffee" to use the new image
updated = 0
for category in menu_data:
    for item in category.get('items', []):
        if item['name'] == 'Ginger Coffee':
            item['image'] = 'assets/images/ginger_coffee_premium.png'
            updated += 1
...
print(f"Updated {updated} menu items for Ginger Coffee")

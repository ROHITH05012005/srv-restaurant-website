...
menu_images = {
    # 1. CURRIES (11 new items)
    "channa_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Channa Masala, spiced chickpeas cooked in a tangy onion-tomato gravy, served warm in a dark clay bowl, garnished with fresh ginger juliennes and coriander. Dark background, dramatic lighting, food photography.",
    "aloo_gobi_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Aloo Gobi Masala, potato cubes and cauliflower florets sautéed with ginger and Indian spices, served in a dark ceramic dish, garnished with coriander. Dark background, cinematic lighting, food photography.",
    "baby_corn_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Baby Corn Masala, sliced tender baby corn cooked in a rich, spiced yellow onion gravy, served in a premium dark bowl. Dark background, luxury plating, cinematic lighting, food photography.",
    "gobi_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Gobi Masala, fresh cauliflower florets cooked in a thick spicy reddish gravy, served in a black bowl. Dark background, dramatic lighting, food photography.",
    "green_peas_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Green Peas Masala, sweet green peas simmered in a mildly spiced green-yellow cream gravy, served warm in a dark bowl, garnished with a swirl of fresh cream. Dark background, cinematic lighting, food photography.",
    "paneer_palak_premium.png": "A premium, realistic, mouth-watering close-up photography of Palak Paneer, soft white paneer cubes submerged in a healthy, thick spiced spinach green purée, served in a dark clay pot. Dark background, luxury food photography.",
    "mix_veg_curry_premium.png": "A premium, realistic, mouth-watering close-up photography of Mix Veg Curry, assorted colorful vegetables cooked in a traditional Indian spiced brown gravy, served in a black bowl. Dark background, cinematic lighting, food photography.",
    "veg_hyderabadi_premium.png": "A premium, realistic, mouth-watering close-up photography of Veg Hyderabadi, mixed vegetables cooked in a spicy green spinach-mint gravy, garnished with ginger juliennes and served in a dark dish. Dark background, dramatic lighting, food photography.",
    "kadai_mushroom_premium.png": "A premium, realistic, mouth-watering close-up photography of Kadai Mushroom, fresh button mushrooms stir-fried with diced bell peppers, onions, and coarse kadai spices, served in a mini black kadai. Dark background, dramatic lighting, food photography.",
    "paneer_kadai_premium.png": "A premium, realistic, mouth-watering close-up photography of Kadai Paneer, soft paneer cubes tossed with red & green capsicum, onion, and fresh kadai spices, served in a dark bowl. Dark background, cinematic lighting, food photography.",
    "paneer_tikka_masala_premium.png": "A premium, realistic, mouth-watering close-up photography of Paneer Tikka Masala, grilled charred paneer tikka pieces in a vibrant orange, spicy and creamy tikka gravy, garnished with coriander, served in a dark ceramic bowl. Dark background, dramatic lighting, food photography.",

    # 2. RICE & NOODLES (11 new items)
    "paneer_fried_rice_premium.png": "A premium, realistic, mouth-watering close-up photography of Paneer Fried Rice, wok-fried rice tossed with golden sautéed paneer cubes, chopped spring onions, and carrots, served in a black bowl. Dark background, cinematic lighting, food photography.",
    "combination_fried_rice_premium.png": "A premium, realistic, mouth-watering close-up photography of Combination Fried Rice, Chinese rice tossed with a mix of paneer, baby corn, mushrooms, and mixed veggies, served in a dark bowl. Dark background, dramatic lighting, food photography.",
    "ginger_garlic_fried_rice_premium.png": "A premium, realistic, mouth-watering close-up photography of Ginger Garlic Fried Rice, aromatic basmati rice stir-fried with golden minced garlic, fresh ginger, and spring onions, served in a black plate. Dark background, cinematic lighting, food photography.",
    "baby_corn_fried_rice_premium.png": "A premium, realistic, mouth-watering close-up photography of Baby Corn Fried Rice, crispy baby corn slices stir-fried with seasoned basmati rice and vegetables, served in a dark bowl. Dark background, dramatic lighting, food photography.",
    "veg_noodles_premium.png": "A premium, realistic, mouth-watering close-up photography of Veg Hakka Noodles, stir-fried thin noodles tossed with shredded cabbage, carrots, bell peppers, and spring onions, served with chopsticks in a dark bowl. Dark background, cinematic lighting, food photography.",
    ...
    "mushroom_noodles_premium.png": "A premium, realistic, mouth-watering close-up photography of Mushroom Noodles, wok-tossed noodles with tender sautéed button mushrooms, green onions, and light soy sauce, served in a black dish. Dark background, cinematic lighting, food photography.",
    "paneer_noodles_premium.png": "A premium, realistic, mouth-watering close-up photography of Paneer Noodles, stir-fried Chinese noodles topped with seasoned paneer strips, carrots, and spring onions, served in a dark plate. Dark background, dramatic lighting, food photography.",
    "singapore_noodles_premium.png": "A premium, realistic, mouth-watering close-up photography of Singapore Noodles, yellow curry-flavored thin rice vermicelli noodles stir-fried with bell peppers and sprouts, served in a dark bowl. Dark background, cinematic lighting, food photography.",
    ...
    "palak_kichidi_premium.png": "A premium, realistic, mouth-watering close-up photography of Palak Khichdi, comforting rice-lentil porridge blended with vibrant green spinach purée, topped with fried garlic and ghee, served in a black bowl. Dark background, cinematic lighting, food photography.",
    ...
    "paneer_tawa_pulav_premium.png": "A premium, realistic, mouth-watering close-up photography of Paneer Tawa Pulav, spicy tawa-fried rice loaded with capsicum, tomatoes, and golden sautéed paneer cubes, served with raita in a dark plate. Dark background, cinematic lighting, food photography.",
    ...
    "veg_mushroom_grill_sandwich_premium.png": "A premium, realistic, mouth-watering close-up photography of Grilled Mushroom Sandwich, golden brown grilled bread filled with creamy garlic sautéed mushrooms and herbs, cut in half. Dark background, cinematic lighting, food photography.",
    ...
    "srv_special_ice_cream_premium.png": "A premium, realistic, mouth-watering close-up photography of our signature Ice Cream Sundae, three layers of different ice cream scoops topped with mixed dry fruits, colorful syrups, wafers, and a cherry. Dark background, food photography.",
...
def get_api_key():
    ...
    # 2. Check local file
    if os.path.exists("pollinations_key.txt"):
        with open("pollinations_key.txt", "r") as f:
            return f.read().strip()
...
def main():
    ...
    if api_key:
        print("Using Pollinations API Key for authentication (bypassing rate limits).")
        # Add key to headers
        headers['Authorization'] = f"Bearer {api_key}"
        # Authenticated requests don't need a heavy delay
        delay = 0.5
    else:
        print("No API key found. Running in ANONYMOUS mode (subject to IP rate limits).")
        delay = 3.5
        
    print(f"Starting sequential Sana downloader for {total} images...")
        ...
        while retries > 0 and not success:
            try:
                ...
                if retries == 0:
                    ...
                    print(f"Error ({e}), retrying in 4s... ", end="", flush=True)
                    time.sleep(4.0)
                    
    print(f"\nExecution Finished! Total: {total} | Downloaded: {downloaded} | Skipped: {skipped} | Failed: {failed}")

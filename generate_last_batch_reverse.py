...
print(f"Found {len(missing_items)} missing items. Processing batch of {batch_size}...")

# Take last batch_size and reverse
target_items = list(reversed(missing_items[-batch_size:])) if len(missing_items) > 0 else []
